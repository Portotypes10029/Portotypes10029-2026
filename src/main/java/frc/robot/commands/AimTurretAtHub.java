...
public class AimTurretAtHub extends Command {
    ...
    public AimTurretAtHub(TurretSubsystem turret,
    ...
    public void execute() {
        ...
        if ((int)limelight.getID(llName) != 26 || (int)limelight.getID(llName) != 10) {
            turret.stopTurret();
            return;
        }
    ...
    public boolean isFinished() {
        return limelight.hasTarget(llName)
            && ((int)limelight.getID(llName) == 26 || (int)limelight.getID(llName) == 10)
