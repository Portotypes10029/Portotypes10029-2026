...
|LEFT JOYSTICK
- Y Axis: Forward / Backward drive
- X Axis: Left / Right strafe

|RIGHT JOYSTICK
- X Axis: Rotate robot (turn left/right)
...
|B BUTTON
- Point wheels in direction of left stick (used for testing?)
...
public class RobotContainer {
    ...
    //XboxController driverController = new XboxController(TunerConstants.kDriverControllerPort);
    ...
    private void configureBindings() {
        ...
        driverController.leftTrigger()
            .whileTrue(new RunCommand(() -> shooter.intakeFuel(), shooter));
